...
#   scripts/e2e_full.sh --dataset obr  # Use specific dataset
#
# Environment:
...
#   E2E_DATASET=obr    Dataset to use for tests
#
# Output:
...
for test in "${ALL_TESTS[@]}"; do
	...
	# shellcheck disable=SC2086  # CARGO_ARGS/NOCAPTURE_FLAG are word lists; splitting intended
