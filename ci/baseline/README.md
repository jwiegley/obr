...
b867ed05 (0.3.2 base), down from 43 in the prior record on the 0.2.22 base
(pre-compaction history; that commit no longer resolves). **No script reads it.** It is named so it can never be mistaken for
